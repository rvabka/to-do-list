...
function ToDoItem({ id, text, date, deleteTask }) {
  return (
    <>
      <motion.li
        animate={{ scale: 1, opacity: 1 }}
        exit={{ scale: 0.8, opacity: 0 }}
        className="flex justify-between items-center w-11/12 mx-auto p-4 rounded-lg shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] font-bold text-lg mt-3"
      >
